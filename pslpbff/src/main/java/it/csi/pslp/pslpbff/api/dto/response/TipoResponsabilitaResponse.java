...
public class TipoResponsabilitaResponse extends CommonResponse {
	...
	public static final class Builder {
		...
		public TipoResponsabilitaResponse build() {
			TipoResponsabilitaResponse result = new TipoResponsabilitaResponse();
			result.setTipoResponsabilita(tipoResponsabilita);
			return result;
		}
