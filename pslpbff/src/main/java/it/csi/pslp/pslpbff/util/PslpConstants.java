...
{
	public final static String COMPONENT_NAME = "pslpbff";

	public static final String LOGGER_NAME = "pslpbff";
	...
	public static final String SILPAPI_URL_DECODIFICA_FIND_COMUNE_BY_PROVINCIA = SILPAPI_URL_DECODIFICA + "find-comuneByIdProvincia/%s";
	public static final String SILPAPI_URL_DECODIFICA_FIND_COMUNE_BY_PROVINCIA_FILTRO = SILPAPI_URL_DECODIFICA + "fill-comuneByIdProvincia/%s/%s"; //0: id provincia, 1: txt per filtro
	public static final String SILPAPI_URL_DECODIFICA_FIND_INFORMATICADETT_BY_IDINFORMATICA = SILPAPI_URL_DECODIFICA + "find-informaticaDettByIdInformatica/%s";
	public static final String SILPAPI_URL_DECODIFICA_FIND_TIPO_LAVORO = SILPAPI_URL_DECODIFICA + "find-tipo-lavoro/%s";
	public static final String SILPAPI_URL_DECODIFICA_FIND_TITOLO_STUDIO_BY_ID = SILPAPI_URL_DECODIFICA + "find-titoloStudioById/%s"; //0: id titolo studio
	...
	public static final String SILPAPI_URL_NOTIFICHE = "/notifiche/";
	public static final String SILPAPI_URL_NOTIFICHE_PULLNOTIFY = SILPAPI_URL_NOTIFICHE + "pullNotify";
	public static final String SILPAPI_URL_NOTIFICHE_RICERCA = SILPAPI_URL_NOTIFICHE + "ricercaNotifiche";
	public static final String SILPAPI_URL_NOTIFICHE_AGGIORNA = SILPAPI_URL_NOTIFICHE + "aggiornaNotifica";

	public static final String SILPAPI_INVIA_DATI_CV="/curriculum/aggiorna-fascicolo-da-curriculum-vitae";

	public static final String SILPAPI_MULTICANALE_INSERT_MSG  = "/msg-multicanale/insert-msg";

	public static final String SILPAPI_URL_DOCUMENTI = "/documenti/";
	...
	public static final String SILPAPI_URL_PROFILING_QUANTITATIVO_FIND_TIPO_PATENTE = SILPAPI_URL_PROFILING_QUANTITATIVO + "find-tipoPatenteFlgPossesso/%s"; //flgPossesso "S" o "N"
