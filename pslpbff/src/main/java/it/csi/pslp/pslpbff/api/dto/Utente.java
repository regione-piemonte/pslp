...
import it.csi.pslp.pslpbff.api.dto.silpapi.Cpi;
import it.csi.pslp.pslpbff.api.dto.silpapi.LavSapSez6;
import lombok.Data;
...
public class Utente {
	...
	@JsonProperty("cpiComp")
	private Cpi cpiComp;

	@JsonProperty("lavSapSez6")
	private List<LavSapSez6> lavSapSez6;
