...
@Component({
  selector: 'pslpwcl-visualizza-annunci-profili-ricercati',
  templateUrl: './visualizza-annunci-profili-ricercati.component.html',
  styleUrls: ['./visualizza-annunci-profili-ricercati.component.scss']
})
export class VisualizzaAnnunciProfiliRicercatiComponent implements OnInit {
