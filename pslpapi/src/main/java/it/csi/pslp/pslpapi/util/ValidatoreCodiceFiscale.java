...
public class ValidatoreCodiceFiscale {
  ...
  public static boolean verificaSeFormalmenteValido(String codiceFiscale) {
    ...
    /* M.CORSINI CAMBIO CRITERI PER SEGNALAZIONE 1201
  ...
  // m.corsini metodo inserito per segnalazione 1201 - omocodia sui codici fiscali
  ...
  private static void check(String cf, String cognome, String nome, String dataDiNascita, String sesso, String comune, boolean checkAtteso) {
    System.out.println(cf+": "+(checkAtteso==ValidatoreCodiceFiscale.confrontaCodiceFiscaleGeneratoConQuelloInserito(cognome, nome, dataDiNascita, sesso, comune, null, cf)));
  }
