...
import it.csi.pslp.pslpbff.api.AnnunciApi;
...
@Provider
public class AnnunciApiServiceImpl extends BaseApiServiceImpl implements AnnunciApi {
	...
	private CallInfo impostaCallInfo() {
		...
		if (null != utente && null != utente.getCfUtente()) {
			info.setCodFiscale(utente.getCfUtente());
		} else {
			info.setCodFiscale("PIPPO");
		}
    ...
    @Audited
	@Override
	public Response insertCollegamentoAnnuncioCandidatura(CollegamentoAnnuncioCandidaturaRequest request,
    ...
    @Audited
	@Override
	public Response elencoCollegamentoAnnuncioCandidatura(CollegamentoAnnuncioCandidaturaListRequest request,
			SecurityContext securityContext, HttpHeaders httpHeaders, HttpServletRequest httpRequest) {
    	request.setCallInfo(impostaCallInfo());
    	return restUtils.chiamatePost(uriInfo,request,blpapiUrl,blpapiUser,blpapiPassword);
	}
    ...
    @Audited
	@Override
	public Response aggiornaStatoCollegamentoAnnuncioCandidatura(CollegamentoAnnuncioCandidaturaRequest request,
			SecurityContext securityContext, HttpHeaders httpHeaders, HttpServletRequest httpRequest) {
    	request.setCallInfo(impostaCallInfo());
    	return restUtils.chiamatePost(uriInfo,request,blpapiUrl,blpapiUser,blpapiPassword);
	}
    ...
    @Audited
	@Override
	public Response getDettaglioAnnuncio(@NotNull Long idAnnuncio,
			SecurityContext securityContext, HttpHeaders httpHeaders, HttpServletRequest httpRequest) {
    ...
    @Audited
	@Override
	public Response stampaElencoVacancyCandid(CollegamentoAnnuncioCandidaturaListRequest request, String format,
			SecurityContext securityContext, HttpHeaders httpHeaders, HttpServletRequest httpRequest) {
    	request.setCallInfo(impostaCallInfo());
    	return restUtils.chiamatePost(uriInfo,request,blpapiUrl,blpapiUser,blpapiPassword);
	}
    ...
    @Audited
	@Override
	public Response ricercaAnnunci(RicercaAnnunciRequest request, @Min(-1) @NotNull int page,
			int recForPage, SecurityContext securityContext, HttpHeaders httpHeaders, HttpServletRequest httpRequest) {
    	request.setCallInfo(impostaCallInfo());
    	return restUtils.chiamatePost(uriInfo,request,blpapiUrl,blpapiUser,blpapiPassword);
	}
